                ...
                <div className="mx-auto max-w-7xl">
                    <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-4">
                        <div className="w-full md:w-auto">
                            ...
                            {currentArticle && (
                                <div className="border-l-4 border-yellow-400 pl-4 transition-all duration-300 text-left bg-black/40 backdrop-blur-sm p-3 rounded-r-lg border-y border-r border-gray-800/50">
                    ...
                    {currentArticle ? (
                        <div className="mt-8 relative z-10">
                            <div className="relative h-[400px] w-full overflow-hidden rounded-xl shadow-2xl border border-gray-800/50 bg-black/50">
                    ...
                    ) : <div className="text-center text-gray-400 mt-10 bg-black/40 backdrop-blur-sm py-10 rounded-xl border border-gray-800">Belum ada berita.</div>}

                    {newsData.length > 0 && (
                        <div className="mt-8 flex items-center gap-4">
                            <button onClick={handlePrev} className="p-2 border-2 border-gray-600 bg-black/50 backdrop-blur-sm text-gray-400 hover:border-white hover:text-white rounded-lg transition-colors"><ChevronLeft /></button>
                            <button onClick={handleNext} className="p-2 border-2 border-gray-600 bg-black/50 backdrop-blur-sm text-gray-400 hover:border-white hover:text-white rounded-lg transition-colors"><ChevronRight /></button>
                        </div>
                    )}
                </div>
