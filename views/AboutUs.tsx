    ...
    return (
        <div className="relative min-h-screen w-full py-16 lg:py-24 px-4 sm:px-6 lg:px-8 mt-16 lg:mt-0 font-sans overflow-x-hidden selection:bg-yellow-400 selection:text-black">
            ...
            <div className="relative z-10">
                <div className="mx-auto max-w-7xl text-center mb-16">
                    <div className="text-center">
                        <div className="flex justify-center items-center gap-4 mb-4">
                            ...
                            <h1 className="text-4xl font-bold tracking-wider uppercase text-white sm:text-5xl drop-shadow-lg">About Us</h1>
                        </div>
                    </div>
                    <div className="w-40 h-1 bg-yellow-400 mx-auto mt-8 shadow-[0_0_10px_rgba(250,204,21,0.5)]"></div>
                </div>

                <div className="relative w-full max-w-6xl mx-auto h-[220px] md:h-[500px] overflow-hidden rounded-lg md:rounded-xl border border-gray-800 shadow-2xl group mb-16 px-4 md:px-0 animate-banner-entrance bg-black/50 backdrop-blur-sm">
                    <div
                    ...
                    <button onClick={prevBanner} className="absolute left-2 top-1/2 -translate-y-1/2 z-20 bg-black/50 p-1 md:p-2 rounded-full text-white hover:bg-yellow-400 hover:text-black transition-colors">
                        <ChevronLeft size={24} className="md:w-8 md:h-8" />
                    </button>
                    <button onClick={nextBanner} className="absolute right-2 top-1/2 -translate-y-1/2 z-20 bg-black/50 p-1 md:p-2 rounded-full text-white hover:bg-yellow-400 hover:text-black transition-colors">
                ...
                >
                    <h2 className="mb-8 text-2xl md:text-4xl font-bold uppercase tracking-widest text-white border-b border-gray-800 pb-4 drop-shadow-lg">
                        Tentang <span className="text-yellow-400">SITH-S</span>
                    </h2>
                    <p className="text-sm md:text-xl leading-relaxed text-gray-300 text-justify md:text-center bg-black/40 p-6 md:p-8 rounded-2xl backdrop-blur-md border border-gray-800/50 shadow-xl">
                ...
                >
                    <h2 className="mb-12 text-2xl md:text-4xl font-bold uppercase tracking-widest text-white drop-shadow-lg">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        <img
                            ...
                            className="w-64 h-64 md:w-80 md:h-80 lg:w-[450px] lg:h-[450px] object-contain drop-shadow-[0_0_25px_rgba(250,204,21,0.6)] hover:scale-105 transition-transform duration-500"
                        />
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-5xl px-6 pb-16 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 text-center md:text-left">
                        ...
                        <div
                            id="makna-logo"
                            ref={maknaLogoRef}
                            className={`flex flex-col bg-black/40 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-gray-800/50 shadow-xl transition-all duration-1000 ease-out transform ${visibleSections['makna-logo'] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12 md:-translate-x-20'}`}
                        >
                        ...
                        <div
                            id="makna-nama"
                            ref={maknaNamaRef}
                            className={`flex flex-col bg-black/40 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-gray-800/50 shadow-xl transition-all duration-1000 ease-out transform ${visibleSections['makna-nama'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12 md:translate-x-20'}`}
                        >
                            <h3 className="text-xl md:text-2xl font-bold uppercase tracking-wide text-yellow-400 mb-6 border-b border-gray-800 pb-4 text-center">
                                Makna Nama Angkatan
                            </h3>
                ...
                <div className="mx-auto max-w-6xl px-6 py-8 md:py-24 flex flex-col gap-12 md:gap-24">
                    <div
                        id="vision"
                        ref={visionRef}
                        className={`flex flex-col md:flex-row md:w-2/3 self-start gap-4 md:gap-6 bg-black/40 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-gray-800/50 shadow-xl transition-all duration-1000 ease-out transform ${visibleSections['vision'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
                            }`}
                    >
                        ...
                        <div>
                            <h3 className="hidden md:block text-3xl font-bold uppercase tracking-wide text-yellow-400 mb-4 drop-shadow-md">Visi</h3>
                            <p className="text-base md:text-xl text-gray-300 leading-relaxed border-l-2 border-yellow-400/50 pl-4">
                    ...
                    <div
                        id="mission"
                        ref={missionRef}
                        className={`flex flex-col md:flex-row-reverse md:w-2/3 self-end gap-4 md:gap-6 bg-black/40 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-gray-800/50 shadow-xl transition-all duration-1000 delay-300 ease-out transform ${visibleSections['mission'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
                            }`}
                    >
                        <div className="flex items-center gap-4 md:block">
                        ...
                        <div className="text-left md:text-right">
                            <h3 className="hidden md:block text-3xl font-bold uppercase tracking-wide text-yellow-400 mb-4 drop-shadow-md">Misi</h3>
                ...
                <div id="timeline" ref={timelineRef} className="py-12 bg-transparent overflow-hidden">
                    <div className="container mx-auto px-4 md:px-6 mb-4 md:mb-8">
                        <h2 className="text-2xl md:text-3xl font-bold uppercase text-center mb-10 bg-black/60 inline-block px-8 py-3 rounded-2xl backdrop-blur-md border border-gray-800 mx-auto w-max relative -translate-x-1/2 left-1/2 text-white shadow-xl">
                        ...
                        <div className="block md:hidden relative px-4">
                            ...
                            <div className="flex flex-col gap-8">
                                {activitiesData.map((activity, index) => (
                                    ...
                                    >
                                        <div className={`absolute left-[29px] top-4 w-4 h-4 rounded-full border-2 z-10 transition-colors ${selectedActivity.id === activity.id ? 'bg-yellow-400 border-yellow-400 shadow-[0_0_10px_rgba(250,204,21,0.8)]' : 'bg-black border-gray-600'
                                            }`}></div>

                                        <div className={`border-l-2 p-4 rounded-r-lg bg-black/60 backdrop-blur-md transition-all ${selectedActivity.id === activity.id ? 'border-yellow-400' : 'border-gray-700'
                                            }`}>
                                ...
                                <div className="absolute inset-0 flex items-center px-12">
                                    {activitiesData.map((activity, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full border-2 z-20 transition-all duration-300 ${selectedActivity.id === activity.id ? 'bg-yellow-400 border-yellow-400 scale-150 shadow-[0_0_15px_rgba(250,204,21,1)]' : 'bg-black border-gray-600'
                                                    }`}></div>
                                                ...
                                                >
                                                    ...
                                                    <div className={`relative w-64 h-36 rounded-lg overflow-hidden border transition-all duration-300 z-30 ${selectedActivity.id === activity.id ? 'border-yellow-400 shadow-[0_0_20px_rgba(250,204,21,0.5)] scale-105' : 'border-gray-800/80 group-hover:border-yellow-400 group-hover:scale-105'
                                                        }`}>
                                                        <img src={activity.imageUrl} alt={activity.title} className="w-full h-full object-cover" />
                                                        <div className="absolute bottom-0 left-0 w-full bg-black/80 py-1 text-center backdrop-blur-md">
                                                    ...
                                                    <div className={`absolute left-1/2 -translate-x-1/2 w-[300px] text-center px-2 z-40 ${isTop ? 'bottom-full mb-3' : 'top-full mt-3'}`}>
                                                        <p className={`text-sm font-bold uppercase tracking-wider transition-colors drop-shadow-md bg-black/60 backdrop-blur-sm border border-gray-800 rounded py-1 ${selectedActivity.id === activity.id ? 'text-yellow-400 border-yellow-400/50' : 'text-gray-300 group-hover:text-white'
                                                            }`}>
                                                            {activity.title}
                                                        </p>
                                                    </div>
                ...
                <div ref={detailRef} className="relative min-h-[400px] md:min-h-[600px] w-full border-t border-yellow-400/20 py-12 md:py-24 bg-transparent backdrop-blur-sm">
                    <div className="container relative z-10 mx-auto px-6">
                        <div className="flex flex-col gap-8 md:gap-12 lg:flex-row lg:items-center bg-black/40 p-6 md:p-10 rounded-3xl border border-gray-800/50 shadow-2xl backdrop-blur-md">
                            ...
                            <div className="w-full lg:w-2/5">
                                <div className="border-l-2 border-yellow-400 pl-4 md:pl-6 animate-slide-up">
                                    <span className="mb-2 block text-sm md:text-xl font-bold uppercase tracking-widest text-yellow-400 drop-shadow-md">
                                        {selectedActivity.date}
                                    </span>
                                    <h2 className="mb-4 md:mb-6 text-2xl md:text-5xl font-bold text-white drop-shadow-lg">
